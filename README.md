**\*\*Full demo video is accessible by the next link - [Advanced XML Streaming Framework for Pega (full demo)](https://vimeo.com/425783042 "Advanced XML Streaming Framework for Pega (full demo)"). In addition to basic project introduction, it provides advanced demo scenarios for such features as parameterized and multi-page transformations, XSD-driven transformations, transient properties and pages usage, performance comparison test and many others.**
## Inspiration
