### Full demo video is accessible by the link: [Advanced XML Streaming Framework for Pega demonstration](https://vimeo.com/425783042 "Advanced XML Streaming Framework for Pega demonstration"). It is presenting additional demo scenarious for such features as parametrized and multi-page transformation, XSD-driven transformation, transient properties and pages usage, performance comparison test and others.
## Inspiration
