...
4.  **Finally, this solution can be extended to work with JSON as an input or output format for transformation as well.** XSLT 3.0 has a support for XML-to-JSON and JSON-to-XML conversion already ([https://www.w3.org/TR/xslt-30/#json](https://www.w3.org/TR/xslt-30/#json "https://www.w3.org/TR/xslt-30/#json")). This way the solution proposed can bring additional efficiency for integration with REST/JSON services too.
