### Full demo video is accessible by the next link - [Advanced XML Streaming Framework for Pega demonstration](https://vimeo.com/425783042 "Advanced XML Streaming Framework for Pega demonstration"). In addition to project intruduction, it presents advanced demo scenarious for such features as parametrized and multi-page transformation, XSD-driven transformation, transient properties and pages usage, performance comparison test and others.
## Inspiration
