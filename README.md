...
And finally, it was a first great experience for me with demo-movies making topic :-) So I know now which tools to use to record them, convert to desired format, combine from several parts and, finally, publish to Internet - I am thankful to Pega Hackathon for this opportunity as well! I am sure, that each new experience is very valuable and can be applied in the future!
