### Full demo video for Advanced XML Streaming Framework for Pega is accessible by this link: [Extensible Stylesheet Language Transformations technology (XSLT)](https://www.w3.org/TR/xslt/ "Extensible Stylesheet Language Transformations technology"). It is presenting demo scenarious for such features as parametrized and multi-page transformation, XSD-driven transformation, transient properties and pages, performance comparison test and others.
## Inspiration
