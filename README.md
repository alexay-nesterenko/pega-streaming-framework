<code>Full demo video for Advanced XML Streaming Framework is accessible by this link. It is presenting demo scenarious for such features as parametrized and multi-page transformation, XSD-driven transformation, transient properties and pages, performance comparison test and others.</code>
## Inspiration
